...
* teacherinfo_shirt_sizes - If it is set to a (Python) list, such as ``['Small','Med','XLarge','XXL']``, the sizes you enter will override the list of available options that teachers can select from when they update their profiles.
