...
class StudentInfoForm(FormUnrestrictedOtherUser):
    ...
    from esp.users.models import get_shirt_sizes, DEFAULT_SHIRT_SIZES, shirt_types, food_choices
...
class TeacherInfoForm(FormWithRequiredCss):
    ...
    from esp.users.models import get_shirt_sizes, DEFAULT_SHIRT_SIZES, shirt_types
